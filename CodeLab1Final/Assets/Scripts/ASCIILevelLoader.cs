...
public class ASCIILevelLoader : MonoBehaviour
{
    ...
    public GameObject player, teleporter, crate, enemy, horizontalPlatform, verticalPlatform;
            ...
            for (int x = 0; x < characters.Length; x++) //length of the characters in the file
            {
                ...
                switch (c)
                {
                    case 'p':
                        ...
                        break;
                    case 't':
                        newObj = Instantiate(teleporter);
                        break;
                    case 'v':
                        newObj = Instantiate(verticalPlatform);
                        break;
                    case 'h':
                        newObj = Instantiate(horizontalPlatform);
                        break;
                    case 'c':
                        newObj = Instantiate(crate);
                        break;
                    case 'e':
                        newObj = Instantiate(enemy);
                        break;
                    default:
                        newObj = null;
                        break;
